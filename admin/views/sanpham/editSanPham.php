                             ...
                             <table id="faqs" class="table table-hover">
                                 ...
                                 <tbody>
                                     ...
                                     <tr id="faqs-row-<?= $key ?>">
                                         ...
                                         <td><img src="<?= BASE_URL . $value['link_hinh_anh'] ?>" style="width:100px; heigth: 100px" alt=""></td>
...
<script>
  var faqs_row = <?= count($listAnhSanPham); ?>;   /// den day 
      function addfaqs() {
              html = '<tr id="faqs-row-' + faqs_row + '">';
                  html += '<td><img src="https://1557691689.e.cdneverest.net/fast/1325x0/filters:format(webp)/static.5sfashion.vn/storage/product_color/zx59gbFvSuBvjej3DzJjZV7cqtNlfX36.webp" style="width:100px; heigth: 100px" alt=""></td>';
