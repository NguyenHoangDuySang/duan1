...
$product = executeResult($sql, true); //Hàm này có thể thực hiện truy vấn và trả về một sản phẩm duy nhất.


// Lấy sản phẩm liên quan
$category_id = $product['category_id'];
$sql = "select Product.*, Category.name as category_name from Product left join Category on Product.category_id = Category.id where Product.category_id = $category_id order by Product.updated_at desc limit 0,4"; //Lấy 4 sản phẩm mới nhất trong cùng danh mục (category_id) của sản phẩm hiện tại.
	...
	<div class="row">
		...
		<div class="col-md-6">
			<ul class="breadcrumb">
				...
				<!-- link đến trang danh mục sản phẩm -->
...
<script type="text/javascript">
	// Tăng/giảm số lượng sản phẩm trong ô nhập.
...
// Đảm bảo số lượng sản phẩm là số dương.
	function fixCartNum() {
